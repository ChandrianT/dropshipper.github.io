...
<script type="text/javascript" src="<?php echo base_url();?>/assets/back/ckeditor/ckeditor.js"></script>
    ...
    <div id="page-wrapper">
        <div class="row">
           <!-- page header -->
           <div class="col-lg-12">
            <h1 class="page-header">HALAMAN EDIT PRODUK</h1>
        </div>
        <!--end page header -->
    </div>
    <div class="row">
                        ...
                        <div class="col-lg-12">
                           <h5 style='color:red'> <?php echo validation_errors();?></h5>
                             <?php echo form_open_multipart('dsbupdate-product','');?>
                                ...
                                <div class="form-group">
                                    <label>Ketersedian Produk</label>
                                    ...
                                    <?php if($all_product->pro_availability==1){?>
                                        ...
                                        <option selected="" value="2">Habis</option>
                                        <option value="3">Pre Order</option>
                                     <?php }elseif($all_product->pro_availability==3){?>
                                        <option value="1">Ada</option>
                                        <option value="2">Habis</option>
                                        <option selected="" value="3">Pre Order</option>
                                    <?php }?>
                                    </select>
                                </div>
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label>Top Produk</label>
                                    <div class="checkbox">
                                        <label>
                                            <?php if($all_product->top_product==1){?>
                                            <input type="checkbox" name="top_product" value="1" checked="">Pilih Top Product
                                            <?php } else{?>
