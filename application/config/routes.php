...
$route['dsbproduct-list'] = 'dsbProduct/show_product_list';
$route['dsbsave-product'] = 'dsbProduct/insert_product';
$route['dsbedit-product/(.+)'] = 'dsbProduct/edit_product/$1';
$route['dsbupdate-product'] = 'dsbProduct/update_product';
$route['dsbdelete-product/(.+)'] = 'dsbProduct/delete_product/$1';
