...
class Veritrans {
    ...
    */
    ...
    {	
		...
		// jika $result_array null atau tidak punya status_code
		if (!$result_array || !isset($result_array->status_code)) {
			return null; // biar nggak bikin error
		}

		if (!in_array($result_array->status_code, array(200, 201, 202, 407))) {
			// jangan langsung throw error, bisa return object untuk dicek di controller
			return $result_array;
		}
	}
